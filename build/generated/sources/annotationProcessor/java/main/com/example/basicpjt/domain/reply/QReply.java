...
public class QReply extends EntityPathBase<Reply> {
    ...
    private static final long serialVersionUID = 905897613L;
    ...
    public final com.example.basicpjt.domain.board.QBoard board;
    ...
    public QReply(Class<? extends Reply> type, PathMetadata metadata, PathInits inits) {
        ...
        this.board = inits.isInitialized("board") ? new com.example.basicpjt.domain.board.QBoard(forProperty("board")) : null;
    }
